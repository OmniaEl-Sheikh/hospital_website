...
namespace El_Catalan_Hospital.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        private int GetAdminIdFromToken()
        {
            ...
            if (int.TryParse(adnID, out int AdminID)) { return AdminID; }
            return 0;
        }
        //--------------------------------------------------------------------
        ...
        public IActionResult DeleteReceptionistData(int id)
        {
            ...
            var DeletedReceptionist = adminService.DeleteReceptionistById(id);
        ...
        public async Task<ActionResult> RegisterReceptionist(RegisterDto model)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<ActionResult> RegisterDoctor(RegisterDto model, int specializationId)
        {
            try
            {
                if (!ModelState.IsValid)
